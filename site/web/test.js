window.onload = function() {
    ...
    */
    var note="";
                                            /* -->Enter what you want the script to
    ...
    var minute=11;      /* -->Enter the count down target date MINUTE */
    ...
    function countdown(yr,m,d,hr,min){
        ...
        if(dday<=0&&dhour<=0&&dmin<=0&&dsec<=0){
            ...
            if((dday>=-1) && (dhour>=-1) && (dmin>=-9)){
                note="Year Beast has arrived!";
                document.getElementById('note').innerHTML=note;
                document.getElementById('note').style.display="block";
                document.getElementById('countdown').style.display="none";
                startTimer = setTimeout("countdown(theyear,themonth,theday,thehour,theminute)",1000);
            }
            else{
                note="Year Beast now dormant";
                document.getElementById('note').innerHTML=note;
                document.getElementById('note').style.display="block";
                document.getElementById('countdown').style.display="none";
